function generatePokemonCardHTML(pokeData, typeClass, index) {
  return /*html*/ `
    <div class="pokemonCard" onclick="showPokemonCardFullscreen(${index})">
      <div class="numberDiv">
      ...
      <div class=" ${typeClass} pokemonBackground">
        <img class="pokemonImg" src="${pokeData.sprites.other["official-artwork"].front_default}" alt="${pokeData.name}" />
      </div>
      <div class="infoType">    
  ...
  function generateFullscreenCardHTML(pokeData, typeClass) {
    ...
    return /*html*/`
        <div class="arrowns">
          <div class="prevCard" id="prevCard" onclick="prevCard()">PREV</div>
          <div class="closeButtonDiv">
            <div class="closeButton" onclick="closeFullscreen()">x</div>
          </div>
          <div class="nextCard" id="nextCard" onclick="nextCard()">NEXT</div>
        </div>
        <div class="nameDIv">
        ...
        <div style="display: flex; justify-content: center;">
          <div class="${typeClass} typeBackgroundFullscreen">
            <img class="pokemonImgFullscreen" src="${pokeData.sprites.other["official-artwork"].front_default}" alt="${pokeData.name}" />
          </div>
        </div>
        <div class="infoBox">
